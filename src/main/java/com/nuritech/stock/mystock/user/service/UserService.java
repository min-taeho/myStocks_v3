...
import com.nuritech.stock.mystock.user.dto.RefreshTokenUpdateRequestDto;
...
public class UserService implements UserDetailsService {
     ...
     */
    @Transactional
    public Long authenticate(String email, String password) throws Exception {
        try {
            UserEntity userEntity = this.loadUserByUsername(email);
